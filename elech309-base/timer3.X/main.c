 ...
 * The RB15 timing is now as expected and independent of the execution
 * of alongTask()
 */
 ...
 */
void __attribute__((interrupt, no_auto_psv))_T1Interrupt(void) { // auto called when Timer1's flag is changed to 1
